...
final class RegisterPremisesIdentifier implements BusinessActionHandlerContract
{
    ...
    public function handle(ActionRequest $request): ActionHandlerResult
    {
        ...
        $record = $this->repository->registerIdentifier($premises, $payload, $request->companyId);
        return new ActionHandlerResult(
            data: $record,
            aggregate: new TypedReference('premises_identifier', (string) $record['public_id']),
            events: [new PendingDomainEvent('workcore.premises.identifier.registered', 1, ['record' => $record, 'premises_public_id' => $premises])],
        );
    }
}
