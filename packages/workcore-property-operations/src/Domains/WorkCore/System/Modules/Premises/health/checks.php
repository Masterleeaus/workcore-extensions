...
return [
    [
        'id' => 'managedpremises:module_json',
    ...
    [
        'id' => 'managedpremises:service_provider',
    ...
    [
        'id' => 'managedpremises:migrations_dir',
...
[
    'id' => 'managedpremises:automation_config',
