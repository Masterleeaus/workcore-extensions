...
final class ApprovePremises implements BusinessActionHandlerContract
{
    ...
    public function handle(ActionRequest $request): ActionHandlerResult
    {
        ...
        $record = $this->repository->approve($premises, $payload, $request->companyId, $request->actorId);
        return new ActionHandlerResult($record, new TypedReference('premises', $premises), [new PendingDomainEvent('workcore.premises.approved', 1, ['premises'=>$record])]);
    }
}
