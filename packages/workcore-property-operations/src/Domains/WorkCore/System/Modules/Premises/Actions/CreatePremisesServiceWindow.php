...
final class CreatePremisesServiceWindow implements BusinessActionHandlerContract
{
    ...
    public function handle(ActionRequest $request): ActionHandlerResult
    {
        ...
        $record = $this->repository->createServiceWindow($premises, $payload, $request->companyId);
        return new ActionHandlerResult(
            data: $record,
            aggregate: new TypedReference('premises_service_window', (string) $record['public_id']),
            events: [new PendingDomainEvent('workcore.premises.service_window.created', 1, ['record' => $record, 'premises_public_id' => $premises])],
        );
    }
}
