...
final class StartAssetMaintenance implements BusinessActionHandlerContract
{
    ...
    public function handle(ActionRequest $request): ActionHandlerResult
    {
        ...
        $record = $this->repository->startMaintenance($asset, $maintenance, $request->payload, $request->companyId, $request->actorId);
        return new ActionHandlerResult(
            data: $record,
            aggregate: new TypedReference('asset', $asset),
            events: [new PendingDomainEvent('workcore.asset.maintenance_started', 1, ['asset_public_id' => $asset, 'maintenance' => $record])],
        );
    }
}
