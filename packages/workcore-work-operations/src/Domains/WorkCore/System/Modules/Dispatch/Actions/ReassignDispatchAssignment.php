...
final class ReassignDispatchAssignment implements BusinessActionHandlerContract
{
    public function __construct(private DispatchRepositoryContract $repository) {}

    public function handle(ActionRequest $request): ActionHandlerResult
    {
        $record = $this->repository->reassign(
        ...
        return new ActionHandlerResult(
            ...
            events: [new PendingDomainEvent('workcore.dispatch.reassigned', 1, ['dispatch' => $record])],
        );
    }
}
