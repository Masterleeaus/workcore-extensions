...
final class CreateCompany
{
    public function __construct(
        private DefaultSalesPipelineProvisioner $salesPipelines,
        private PrivilegedTenantAccessContract $privileged,
    ) {}
    ...
    public function execute(CreateCompanyData $data): Company
    {
        return $this->privileged->run(
            $data->ownerUserId,
            'Create a WorkCore tenant and bootstrap its owner, roles and sales defaults.',
            function () use ($data): Company {
